...
function renderAnomalies() {
  ...
  ['POPLUZ', 'POPN1', 'POPZOE', 'POPSUR', 'POPBEA'].forEach(platform => {
...
function formatPlatformBadge(platform) {
  ...
  if (value === 'POPZOE') return '<span class="platform-badge platform-popzoe">POPZOE</span>';
  if (value === 'POPSUR') return '<span class="platform-badge platform-popsur">POPSUR</span>';
  if (value === 'POPBEA') return '<span class="platform-badge platform-popbea">POPBEA</span>';
